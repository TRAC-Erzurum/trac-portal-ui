...
const exportTemplateRef = ref<InstanceType<typeof ExportReportTemplate> | null>(
  null,
);
...
<template>
  <div
    class="min-h-screen flex flex-col items-center justify-center p-6 bg-background"
  >
    <p
      v-if="status === 'loading'"
