  ...
  <div class="min-h-screen flex">
    <div class="hidden lg:flex lg:w-1/2 bg-primary/5 items-center justify-center p-12">
      <div class="max-w-md text-center">
        ...
        <h1 class="text-4xl font-bold mb-4">{{ t('brand.portalTitleAlt') }}</h1>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-8 overflow-y-auto">
      <Card class="w-full max-w-lg my-8">
        <CardHeader class="text-center">
          ...
          <CardDescription class="hidden sm:block">{{ t('auth.registerSubtitle') }}</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <p class="text-xs text-muted-foreground text-center mt-2 mb-2">
            {{ t('auth.privacyConsentRegister', { link: '' }) }}
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div class="flex items-center gap-3 pt-2">
              ...
              <label for="privacy" class="text-sm cursor-pointer select-none">
                {{ t('auth.privacyConsentCheckbox', { link: '' }) }}
